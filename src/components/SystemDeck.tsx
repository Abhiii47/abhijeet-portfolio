...
export default function SystemDeck() {
    ...
    return (
        ...
        >
            {/* 3D Isometric Deck */}
            <div
                className="deck-container relative grid grid-cols-2 md:grid-cols-5 gap-4 p-8 bg-[#1a1a1a] border border-white/5 rounded-2xl shadow-2xl [transform-style:preserve-3d] will-change-transform"
                style={{
                    transform: "rotateX(45deg) rotateZ(45deg) rotateY(-20deg)",
                    boxShadow: activeModule
                        ? `0 30px 60px -15px ${activeModule.color}30`
            ...
            >
                ...
                {modules.map((mod) => (
                    <div
                        ...
                        className="module-key group relative w-16 h-16 md:w-20 md:h-20 cursor-pointer [transform-style:preserve-3d] transition-transform duration-100 active:scale-95"
                        style={{
                            transform:
                        ...
                        <div className="absolute inset-0 bg-[#222] rounded-[4px] [transform-style:preserve-3d]">
                            ...
                            <div
                                ...
                                style={{
                                    boxShadow:
                                        activeModule?.id === mod.id
                                            ? `inset 0 0 10px ${mod.color}40, 0 0 15px ${mod.color}40`
                                            : "",
                                }}
                            >
                                <div
                                ...
                                <span
                                    ...
                                    style={{
                                        color:
                                            activeModule?.id === mod.id ? mod.color : undefined,
                                    }}
                                >
                                    {mod.label}
                                </span>
                    ...
                    {!activeModule ? (
                        ...
                        <>
                            <div
                                ...
                                style={{ borderColor: `${activeModule.color}40` }}
                            >
                                ...
                                <div
                                    className="px-2 py-0.5 rounded text-[10px] font-bold bg-white/5 uppercase"
                                    style={{ color: activeModule.color }}
                                >
                                    {activeModule.status}
                                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <p
                                    className="text-sm typing-effect text-gray-200"
                                    key={activeModule.id}
                                >
                                    {activeModule.desc}
                                </p>
