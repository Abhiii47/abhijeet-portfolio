...
const SKILLS = [
  { category: "Backend & Systems", color: ACCENT,    items: ["Node.js","FastAPI","REST APIs","Socket.io","SSE","Docker","CI/CD","OAuth2","RBAC"] },
  { category: "ML & Data",         color: "#a78bfa", items: ["XGBoost","LightGBM","CatBoost","Scikit-learn","Pandas","NumPy","FAISS","RAG","LLMs"] },
  { category: "Cloud & Infra",     color: "#fb923c", items: ["AWS (EC2/S3/IAM)","GCP Vertex AI","GCP Vision","Microsoft Fabric","DP-600","CloudWatch"] },
  { category: "Frontend & BI",     color: "#4ade80", items: ["React","Next.js","Tailwind","TypeScript","Power BI","DAX","GSAP"] },
];
...
export default function About() {
  ...
  useGSAP(() => {
    ...
    /* Stats row — each stat pops in with 3D flip */
    gsap.from(".ab-stat", {
    ...
    >
      ...
      <div style={{ maxWidth: 1140, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div className="about-2col" style={{
          ...
          {/* LEFT — pull quote with word-by-word reveal */}
          <div>
            <h2
            ...
            >
              {[
                { text: "Building", color: "var(--ink)" },
                { text: "systems", color: "var(--ink)" },
                { text: "that",    color: "var(--ink)" },
                { text: "scale.",  color: ACCENT },
                { text: "Products",color: "var(--ink)" },
                { text: "that",    color: "var(--ink)" },
                { text: "ship.",   color: "transparent", stroke: `1.5px var(--ink)` },
              ].map((w, i) => (
                <span
                  key={i}
                  className="ab-word"
          ...
          <div className="ab-body" style={{ display: "flex", flexDirection: "column", gap: 22, paddingTop: 6 }}>
            {[
              <>I&rsquo;ve been writing code that runs in production since my second year. Not toy projects &mdash; a room-finder platform with live users, a resume analysis engine scoring <strong style={{ color: "var(--ink)" }}>50,000+ CVs</strong>, an OCR finance system processing receipts in real time.</>,
              <>Right now I&rsquo;m at <strong style={{ color: "var(--ink)" }}>Ecovis RKCA</strong>: migrating legacy infra to AWS, building a RAG assistant on GCP, and acting as PM on a client-facing product &mdash; all at the same time.</>,
            ...
            <div className="ab-para" style={{ display: "flex", gap: 16, alignItems: "center", marginTop: 8, flexWrap: "wrap" }}>
              ...
              <a
                ...
                style={{
                  ...
                  color: "var(--ink-hint)", textDecoration: "none",
                  transition: "color 0.2s",
                }}
                onMouseEnter={e => (e.currentTarget.style.color = ACCENT)}
                onMouseLeave={e => (e.currentTarget.style.color = "var(--ink-hint)")}
              >Get in touch &rarr;</a>
            </div>
          </div>
        </div>
        ...
        >
          {STATS.map((s, i) => (
            <div key={i} className="ab-stat" style={{
              ...
              borderLeft: i === 0 ? "none" : "1px solid var(--ink-border)",
            }}>
              <p style={{
                fontFamily: "'Bebas Neue','Arial Black',sans-serif",
              ...
              <p style={{
                ...
                color: "var(--ink-hint)", lineHeight: 1.4,
              }}>{s.note}</p>
            </div>
          ))}
        </div>

        {/* ── Skills groups — 3D tilt cards ── */}
